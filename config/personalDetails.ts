...
export const PHONE_NUMBER = '+1-206-637-1482'
export const TITLE = 'Principal Software Engineer'
export const DESCRIPTION = `${TITLE} 👩‍💻 Trans Woman (she/her) ♀️🏳️‍⚧️`
...
export const URL = `https://emmajsadams.com`
